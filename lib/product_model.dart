...
Experience these incredible PS5 titles, enhanced with the power of PS5 Pro for improved visuals and performance.
...
Content:
➔ Nintendo Switch Console Neon Blue & Red x1
➔ Nintendo Switch Dock x1
➔ Joy-Con (L) & (R)
➔ Joy-Con Strap x2
➔ Joy-Con Grip x1
➔ High Speed HDMI Cable x1
➔ Nintendo Switch AC Adapter x1

Nintendo Switch + Free Temper Glass''',
  ),
  Product(
